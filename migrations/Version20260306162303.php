 ...
 */
final class Version20260306162303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD archive TINYINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE tache CHANGE description description LONGTEXT DEFAULT NULL, CHANGE date date DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tache CHANGE description description LONGTEXT NOT NULL, CHANGE date date DATE NOT NULL');
    }
}
